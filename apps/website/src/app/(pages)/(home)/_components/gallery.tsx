      ...
      <div className="mx-auto max-w-4xl px-6">
        <div className="mx-auto max-w-[560px] text-center">
          ...
          <p className="mt-4 text-pretty text-base text-muted-foreground md:text-lg">
            Every input below is the same component with a different render
            prop. Try them — they all type, paste and autofill for real.
          </p>
        </div>

        <div className="mt-14 grid gap-x-12 gap-y-14 sm:grid-cols-2 md:mt-20">
