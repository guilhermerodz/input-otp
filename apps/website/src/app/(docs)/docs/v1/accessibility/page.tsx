...
const HREF = '/docs/v1/accessibility'
...
export default function AccessibilityPage() {
  return (
    <DocsPage href={HREF}>
      ...
      <P>
        <A href="/docs/v1/mobile">Mobile &amp; platforms</A> covers the rest of
        the real-world behaviour: SMS autofill, iOS paste, and what happens when
