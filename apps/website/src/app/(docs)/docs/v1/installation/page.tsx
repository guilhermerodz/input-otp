...
const HREF = '/docs/v1/installation'
...
export default function InstallationPage() {
  return (
    <DocsPage href={HREF}>
      ...
      <P>
        It uses the <A href="/docs/v1/api#context">Context API</A> form of this
      ...
      <H3>Next</H3>
      <P>
        <A href="/docs/v1/anatomy">Anatomy</A> shows what you just rendered,
        from the inside.
      </P>
    </DocsPage>
  )
