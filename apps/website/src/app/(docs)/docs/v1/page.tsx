  ...
  return (
    ...
    >
      ...
      <P>
        ...
        <A href="/docs/v1/anatomy">Anatomy</A> takes the lid off and shows you
        the whole mechanism.
      </P>
      ...
      <P>
        ...
        <A href="/docs/v1/installation">Installation</A> has the full source to
        copy.
      </P>
      ...
      <P>
        ...
        <A href="/docs/v1/edge-cases">Edge cases</A>.
      </P>
