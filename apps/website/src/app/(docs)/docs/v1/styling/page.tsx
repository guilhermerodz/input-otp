  ...
  return (
    <DocsPage href={HREF}>
      ...
      <P>
        ...
        <A href="/docs/v1/api#context">OTPInputContext</A>.
      </P>
      ...
      <P>
        ...
        only the markup differs. More in{' '}
        <A href="/docs/v1/examples">Examples</A>.
      </P>
      <H3>Underlined</H3>
      ...
      <P>
        ...
        touches your slots. <A href="/docs/v1/edge-cases">Edge cases</A> walks
