    ...
    <DocsPage href={HREF}>
      ...
      <Callout type="note" title="What providing it changes">
        <p>
          ...
          <A href="/docs/v1/edge-cases#ios-refuses-to-paste-into-an-invisible-input">
            see why
          </A>
      ...
      <P>
        <A href="/docs/v1/forms">Forms</A> has that wired up end to end.
      </P>
    </DocsPage>
  )
}
