      ...
      <div className="xp">
        ...
        >
          ...
          <h2
            ...
            style={{
              ...
              margin: 0,
              fontFamily:
                'var(--font-jetbrains), ui-monospace, Menlo, monospace',
              fontSize: 22,
              fontWeight: 600,
        ...
        <section id="how" style={{ padding: '56px 0 0', borderTop: border }}>
          <div style={{ padding: '0 40px' }} data-rv-group>
            ...
            <div
              data-rv="lede"
              style={{ fontSize: 14, color: '#71717a', marginTop: 6 }}
            >
              One real input, wearing your design — the slots you see just
              mirror its state. Keep scrolling
